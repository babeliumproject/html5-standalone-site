...
class Evaluation {
	 ...
	 * 		Returns an array of objects or null if the query didn't have results.
	 */
   ...
   /**
	...
	/**
	 * Performs a sql query whose result is expected to be of one-row length
	 * 
	 * @return mixed $valueObject
	 * 		Returns an object with user info or false when the query didn't have any results
	 */
